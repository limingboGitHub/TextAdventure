...
func get_special_skill() -> DataBaseSkill:
	if special_skill == null and id == "effect_000005":
		...
		skill.center_type = 1
		special_skill = skill
	elif special_skill == null and id == "effect_000030":
		var skill = DataAttackSkill.new(type,"attack")
		skill.count = 99999
		skill.target_type = 1
		skill.level = 1
		...
		skill.damage_level = [[value]]
		special_skill = skill
	elif special_skill == null and id == "effect_000040":
		var skill = DataAttackSkill.new(type,"attack")
		skill.radius = 99999
		skill.count = 99999
		skill.target_type = 1
		...
		skill.center_type = 0
		special_skill = skill
	elif special_skill == null and id == "effect_000049":
		var skill = DataAttackSkill.new(type,"attack")
		skill.count = 99999
		skill.target_type = 1
		skill.level = 1
		skill.name = "爆炎射线"
		skill.damage_source_type = 1
		skill.damage_type = 1
		skill.damage_value_type = value_type
		skill.damage_level = [[value]]
		special_skill = skill
	elif special_skill == null and id == "effect_000054":
		var skill = DataAttackSkill.new(type,"attack")
		skill.count = 99999
		skill.target_type = 1
		skill.level = 1
		skill.name = "巨人冲锋"
		skill.damage_source_type = 3
		skill.damage_type = 0
		skill.damage_value_type = value_type
		skill.damage_level = [[value]]
		special_skill = skill
	elif special_skill == null and id == "effect_000055":
		var skill = DataAttackSkill.new(type,"attack")
		skill.count = 99999
		skill.target_type = 1
		skill.level = 1
		...
		skill.damage_level = [[value]]
		special_skill = skill
	elif special_skill == null and id == "effect_000042":
		var skill = DataAttackSkill.new(type,"attack")
		skill.count = 99999
		skill.target_type = 1
		skill.level = 1
