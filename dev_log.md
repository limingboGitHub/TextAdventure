...
4. 装备描述准确性问题
5. 难度过于简单问题
6. 泰坦之力BUG，全点血量增加特殊效果后，重置属性效果仍然在
7. ~~转职不可逆，需要强提醒~~
8. ~~背包上限问题~~
9. 成就系统？
10. ~~炼金药剂附加的属性大退后永久存在~~
...
## 技能添加：
战士（一击必杀）：
1. 蓄力技能，蓄力2秒，每蓄力0.01秒增加1%伤害。
2. 蓄力卷轴：每点力量增加0.01秒的蓄力时间。
3. 怒气冲天：受到1点伤害积累1点怒气，下次攻击时，每点怒气值增加1%伤害并清空怒气。
4. 

法师（魔法力，特殊效果）:
1. 寒冰光环：创造一个寒冰光环气场，怪物移动范围降低20%
2. 寒冰之力：每点智力额外增加减少怪物0.1%的移动速度
3. 能量震慑：击退怪物一定的距离，击退距离与智力相关

盗贼（移动，闪避）:
1. 追击：击杀怪物后，5%概率瞬间移动到距离自身最远的一只怪物附近
2. 不断看破：每击杀一次该BOSS，则来自该怪物的攻击闪避概率增加1% ？？
3. 毒雾：形成一个半径50的毒雾，对命中的怪物添加中毒buff ？？
4. 乱舞：攻击速度变得越来越快，攻击力变得越来越低。
5. 狂舞：乱舞变成AOE伤害，增加攻击范围
6. 嘲讽：自身一定范围内怪物会主动攻击自己，增加范围半径
...
8. 新增装备锁。
9. 商店新增一页全部出售。
10. 新增伤害详情统计系统（性能考虑默认关闭）。
11. 挂机设置新增炼金药剂自动连续使用。
12. 隐私政策调整，集成友盟崩溃日志采集SDK，用于更好的分析闪退问题。
13. 其他细节优化调整。

本游戏完全免费，开源，且采用最宽松的MIT开源协议，您可以在遵守协议的前提下任意使用、修改、分发本游戏。同时作者也非常鼓励大家进行二次开发。
如果我的开源工作让你收获了一份快乐或者帮助，并且你有能力和意愿，你可以选择资助我，这份资助对我来说很重要，我需要用它过渡到全职游戏开发者的阶段，有更多精力去做更多有意思的游戏。第三方捐赠渠道( https://www.jilvfaka.com/links/3F4CA33527F4DA9D )